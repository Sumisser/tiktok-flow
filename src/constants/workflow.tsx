    ...
    styles: [
      {
        ...
        prompt:
          '富有哲思意境的古典油画风格，注重要场景的宏大构图，极具空间感，细腻的油画质感，空灵意境，细腻的色彩过渡，戏剧性的明暗对照法，冷暖色调和谐搭配，孤独人物剪影，广袤天地意象（麦田、星空、海洋、群山），光明与黑暗的对话，点光源作为希望的象征（灯笼、篝火、晨曦），梦幻诗意的氛围，沉思内省的情绪，象征性的视觉隐喻，博物馆级艺术品质',
      },
      {
        id: 'film_cinematic',
        label: '🎬 电影质感',
